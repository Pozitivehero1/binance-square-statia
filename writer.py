...
ОЧЕНЬ ВАЖНО НЕ УПОМИНАТЬ НАЗВАНИЕ МОНЕТЫ (например $BTC) БОЛЬШЕ ТРЕХ РАЗ, НО МИНИМУМ ОДИН РАЗ НЕ СЧИТАЯ ЗАГОЛОВОК НАДО УПОМЯНУТЬ
...
- Упоминай название монеты не более 3 раз во всей статье.
- не разделяй блоки черточками
- не используй хештеги
- не используй слова:
- указывай конкретно ВХОД, ЦЕЛИ, СТОП-ЛОСС.
  возможно
  вероятно
  скорее всего
  может быть
